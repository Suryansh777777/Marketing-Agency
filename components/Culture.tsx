      ...
      >
        ...
        >
          ...
          <div className="text-[#7b7b7b] max-w-3xl">
            Here we believe that our culture is the foundation of our success.
            Our values are the guiding principles that help us achieve our goals
            and create a positive work environment. Here are the values that
            define us:
          </div>
        </motion.div>
